 ...
 * After INT01_DEVICE AD_ACTIVITY_VISIBLE, close the actual Google test ad using its real UI.
 * This test reuses INT-02's manifest host and real ERain bootstrap; no vendor is substituted.
 */
@RunWith(AndroidJUnit4::class)
class InterstitialLoadAndShowRealGmaDeviceTest {
    private val instrumentation = InstrumentationRegistry.getInstrumentation()
    private val app = ApplicationProvider.getApplicationContext<Application>()

    @Test
    fun expiredUiWaitKeepsRealLateFillForAnExplicitReadyLoadAndShow() {
        ...
        try {
            ...
            ActivityScenario.launch<InterstitialRealGmaDeviceActivity>(
                ...
                Log.i(TAG, "CLOSED real_callback=true retry_complete=1 expired_complete=1")
            }
        } finally {
            instrumentation.runOnMainSync {
    ...
    companion object {
        private const val TAG = "INT01_DEVICE"
        private const val PLACEMENT = "int01_device_real_interstitial"
