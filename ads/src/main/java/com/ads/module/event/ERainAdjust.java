...
public class ERainAdjust {
    ...
    public static void setEventNamePurchase(String eventNamePurchase) {
        ERainAdjust.eventNamePurchase = eventNamePurchase;
    }
    ...
    static void logPaidAdImpressionValue(double revenue, String currency) {
        if (ERainAd.getInstance().getAdConfig().getAdjustConfig() != null && ERainAd.getInstance().getAdConfig().getAdjustConfig().isEnableAdjust()) {
            AdjustEvent event = new AdjustEvent(ERainAd.getInstance().getAdConfig().getAdjustConfig().getEventAdImpression());
