package com.itg.customactivitycrash.config;
...
public class ITGCrashConfig implements Serializable {
    ...
    public static class Builder {
        private ITGCrashConfig config;

        @NonNull
        public static Builder create() {
            Builder builder = new Builder();
            ITGCrashConfig currentConfig = CustomActivityOnCrash.getConfig();

            ITGCrashConfig config = new ITGCrashConfig();
