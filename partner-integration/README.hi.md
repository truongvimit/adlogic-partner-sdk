...
| App की अपनी screens में ads | Ads + OnboardKit गाइड पूरी कर ली है: अपनी app की [AppAdPlacement.kt](examples/ads-onboarding/AppAdPlacement.kt) के साथ [native](ads-onboarding-integration.hi.md#app-की-अपनी-screens-में-native-placement-constant-के-साथ), [inter](ads-onboarding-integration.hi.md#app-की-अपनी-screens-में-interstitial-placement-constant-के-साथ), [reward](ads-onboarding-integration.hi.md#app-स्क्रीन-पर-reward), [app-open](ads-onboarding-integration.hi.md#app-open-on-return) के नमूने इस्तेमाल करें। OnboardKit इस्तेमाल नहीं कर रहे: [Ads](../ads/README.md) को init और placements से लेकर consent तक पूरा करें। | `ads` |
