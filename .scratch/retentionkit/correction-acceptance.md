...
Status: implementation, review, selected fresh tests and stated device/package acceptance passed; physical restoration and task cleanup complete; only external PR completion remains. Correction base `543de038c8e61ae393cdcc5fa84390b199ceda38`; delivery branch `codex/retentionkit`.
