...
- **17 — resolved, scoped implementation:** verified source020196d, final author tipfcfe32f, merged5e26fcf;97 fresh notification tests and release AAR PASS,49 unchanged core cases retained from83f6357,27 Python fixtures PASS. [Checkpoint/source archive](/Users/Shared/Panacea/Documents/SDKOptimize/retentionkit-default-fix/ticket17/final-checkpoint.json). Bounded wake, owned cancellation/recovery and compact notifications are implemented; actual OS wake, integrated facade/app changes and final composition remain Ticket18 acceptance.
- **18 — pending final acceptance:** retains `Blocked by: 15, 16, 17`;15–17 now satisfy their scoped implementation dependencies; integrated artifact, actual device and independent review acceptance remain open. Root owns actual normal-device behavior, final source R8/consumer checks and independent Standards/Spec review. Preserve intermediate/failed evidence and do not add the two separate126/75 invocations to any historical279 or claim one combined invocation.
