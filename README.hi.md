...
यह गाइड version **5.2.3** के लिए है। सभी modules का version एक रखें। बाद में upgrade करते समय उपलब्ध [release tag](https://github.com/truongvimit/adlogic-partner-sdk/tags) चुनें और उसी tag की README पढ़ें।
